...
EPSILON = 7.0
NUMNODES = 5000
XINIT = 80.0    # x-distance in pixels from top left corner
YINIT = 80.0    # y-distance in pixels from top left corner
#XGOAL = 
...
def main():
    ...
    black = 20, 20, 40
    screen.fill(black)
    # goalregion = pygame.Surface((100.0,50.0))
    # goalregion.fill((50.0,150.0,50.0))
    # screen.blit(goalregion, (200.0,200.0))
    nodes = []

#    nodes.append((XDIM/2.0,YDIM/2.0)) # Start in the center
    nodes.append((XINIT,YINIT)) # Start in the corner
